...
const SponseredStudents = () => {
  ...
  const fetchStudents = async () => {
    try {
      const res = await axios.get(API_BASE + "AdminStudent/SponseredDisplay");
                    ...
                    {activeAction === row.id && (
                      <div className="action-dropdown">
                        ...
                        <div
                          style={{ cursor: "pointer" }}
                          onClick={() =>
                            navigate(`/StudentComponent/ReportRouter/${row.id}`)
                          }
                        >
...
export default SponseredStudents;
