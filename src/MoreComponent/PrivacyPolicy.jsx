...
const PrivacyPolicy = () => {
  return (
    <div style={{ padding: "30px" }}>
      ...
      <p style={{ fontFamily: "RedhatR", fontSize: "16px", lineHeight: "1.7" }}>
        <b>Last updated: 01/02/2022</b>
        <br /><br />
        ...
        use of the Service after we post any modifications on this page will
        constitute your acknowledgment of the modifications and your consent to
        abide and be bound by the modified Privacy Policy.
        <br />
        If we make any material changes, we will notify you via email or by
